<template>
    <div>
         <el-row>
            <el-col :span="8">
                <span class="imageMainbox">产品星级评分:</span>
        ...
        <el-row class="textSpeaing">
            <el-col :span="8">
                <span class="imageMainbox">我司目标星级评分:</span>
                <span class="imageMainboxText">{{salesTargetDetaiList.xstargetstarrating}}</span>
            </el-col>
            <el-col :span="8">
                <span class="imageMainbox">产品预估日销量:</span>
        ...
        <el-row class="textSpeaing">
            <el-col :span="8">
                ...
                <span class="imageMainboxText">{{salesTargetDetaiList.xstestsampletime}}</span>
            </el-col>
            <el-col :span="8">
                <span class="imageMainbox">产品下单时间点:</span>
                <span class="imageMainboxText">{{salesTargetDetaiList.xsorderoftime}}</span>
            </el-col>
        </el-row>
    </div>
</template>
